...
class QseverseAPIView(APIView):
    ...
    def post(self, request):
        ...
        serializer = qseverse_serializer.AchievementSerializer(achievement)
    ...
    def put(self, request, achievement_id=None):
        ...
        serializer = qseverse_serializer.AchievementSerializer(achievement, data=data, partial=True)
