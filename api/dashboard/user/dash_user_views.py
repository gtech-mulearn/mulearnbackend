...
<body
    style="background: url('https://i.ibb.co/37C2CGL/Responsive.png') center center/contain no-repeat;width: 400px;height: 800px;">

    <div style="width: 400px;height: 500px; background: transparent;"></div>
    <div style="display: flex;">
        <div style="width: 80px;height: 20px; background: transparent"></div>

        <a href="{domain}/reset-password?token={forget_user.id}/" style="display: flex;padding: 5px; width: 220px;height: 30px;background: url('https://i.ibb.co/LhKgsCH/resetbutton.png') center center/contain no-repeat;"></a>
    </div>
    <div style="width: 310px;height: 90px; background: transparent"></div>
    <div style="display: flex;">
        <div style="width: 160px;height: 20px; background: transparent;"></div>
        <a href="https://www.linkedin.com/company/mulearn/mycompany/"><img src="https://i.ibb.co/RYr8YHc/linkedin.png" alt="linkedin"
                border="0"></a>
        <div style="width: 20px;height: 20px; background: transparent"></div>
        <a href="https://www.instagram.com/gtechmulearn/"><img src="https://i.ibb.co/tJxZw29/insta.png" alt="insta" border="0"></a>
        <div style="width: 20px;height: 20px; background: transparent"></div>
        <a href="https://twitter.com/GtechMulearn"><img src="https://i.ibb.co/MCnV8jP/twitter.png" alt="twitter" border="0"></a>
    </div>
</body>
