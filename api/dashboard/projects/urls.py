...
urlpatterns = [
    ...
    path("<uuid:pk>/status/", projects_view.ProjectStatusAPI.as_view()),
    path("<uuid:project_id>/members/", projects_view.ProjectMemberAPI.as_view()),
    path("<uuid:project_id>/members/<uuid:pk>/", projects_view.ProjectMemberAPI.as_view()),
