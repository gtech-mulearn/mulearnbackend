...
urlpatterns = [
    ...
    path('institutes/show/<str:org_type>/', organisation_views.InstitutionAPI.as_view()),
    path('institutes/show/<str:org_type>/<str:district_id>/', organisation_views.InstitutionAPI.as_view()),
