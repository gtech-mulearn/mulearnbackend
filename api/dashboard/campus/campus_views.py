...
class AssignCampusMentorAPI(APIView):
    ...
    def post(self, request):
        ...
        existing_pending = MentorApplication.objects.filter(
            user=student,
            mentor_tier=MentorApplication.MentorTier.CAMPUS_MENTOR,
            org=org,
        ...
        # Ensure the student has a UserMentor profile so downstream mentor
        # surfaces (profile page, analytics) work once this is approved —
        # mirrors the self-service registration/apply paths.
        ...
        MentorApplication.objects.create(
            ...
            mentor_tier=MentorApplication.MentorTier.CAMPUS_MENTOR,
            org=org,
            reason=f"Nominated by campus lead {user_id}.",
