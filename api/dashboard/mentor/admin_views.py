...
class MentorDeactivationAPI(APIView):
    ...
    def post(self, request, user_mentor_id):
        ...
        try:
            ...
            logger.exception("Failed to notify mentor %s of deactivation", mentor_profile.user_id)
...
class MentorReactivationAPI(APIView):
    ...
    def post(self, request, user_mentor_id):
        ...
        try:
            ...
            logger.exception("Failed to notify mentor %s of reactivation", mentor_profile.user_id)
