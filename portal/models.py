...
class PortalUserAuth(models.Model):
    ...
    created_by = models.ForeignKey(User, models.DO_NOTHING, db_column='created_by', related_name='portal_user_auth_created_by')
    created_at = models.DateTimeField()
...
class PortalUserMailValidate(models.Model):
    ...
    created_by = models.ForeignKey(User, models.DO_NOTHING, db_column='created_by', related_name='portal_user_mail_validate_created_by')
    created_at = models.DateTimeField()
