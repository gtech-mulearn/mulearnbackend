...
class InterestGroup(models.Model):
    ...
    updated_by           = models.ForeignKey(User, on_delete=models.CASCADE, db_column="updated_by", related_name="interest_group_updated_by")
    updated_at           = models.DateTimeField(auto_now=True)
    created_by           = models.ForeignKey(User, on_delete=models.CASCADE, db_column="created_by", related_name="interest_group_created_by")
    created_at           = models.DateTimeField(auto_now_add=True)
...
class UserLvlLink(models.Model):
    ...
    updated_by           = models.ForeignKey(User, on_delete=models.CASCADE, db_column="updated_by", related_name="user_lvl_link_updated_by")
    updated_at           = models.DateTimeField(auto_now=True)
    created_by           = models.ForeignKey(User, on_delete=models.CASCADE, db_column="created_by", related_name="user_lvl_link_created_by")
    created_at           = models.DateTimeField(auto_now_add=True)
...
class TaskType(models.Model):
    ...
    updated_by           = models.ForeignKey(User, on_delete=models.CASCADE, db_column="updated_by", related_name="task_type_updated_by")
    updated_at           = models.DateTimeField(auto_now=True)
    created_by           = models.ForeignKey(User, on_delete=models.CASCADE, db_column="created_by", related_name="task_type_created_by")
    created_at           = models.DateTimeField(auto_now_add=True)
...
class Wallet(models.Model):
    ...
    karma_last_update_at = models.DateTimeField(blank=True, null=True)
    coin                 = models.FloatField(default=0)
    updated_by           = models.ForeignKey(User, on_delete=models.CASCADE, db_column="updated_by", related_name="wallet_updated_by")
    updated_at           = models.DateTimeField(auto_now=True)
    created_by           = models.ForeignKey(User, on_delete=models.CASCADE, db_column="created_by", related_name="wallet_created_by")
    created_at           = models.DateTimeField(auto_now_add=True)
...
class KarmaActivityLog(models.Model):
    ...
    peer_approved_by     = models.ForeignKey(User, on_delete=models.CASCADE, db_column="peer_approved_by", blank =True, null  =True, related_name="karma_activity_log_peer_approved_by")
    appraiser_approved   = models.BooleanField(blank=True, null=True)
    appraiser_approved_by= models.ForeignKey(User, on_delete=models.CASCADE, db_column="appraiser_approved_by", blank =True, null  =True, related_name="karma_activity_log_appraiser_approved_by")
    updated_by           = models.ForeignKey(User, on_delete=models.CASCADE, db_column="updated_by", related_name="karma_activity_log_updated_by")
    updated_at           = models.DateTimeField(auto_now=True)
    created_by           = models.ForeignKey(User, on_delete=models.CASCADE, db_column="created_by", related_name="karma_activity_log_created_by")
    created_at           = models.DateTimeField(auto_now_add=True)
...
class MucoinActivityLog(models.Model):
    ...
    updated_by           = models.ForeignKey(User, on_delete=models.CASCADE, db_column="updated_by", related_name="mucoin_activity_log_updated_by")
    updated_at           = models.DateTimeField(auto_now=True)
    created_by           = models.ForeignKey(User, on_delete=models.CASCADE, db_column="created_by", related_name="mucoin_activity_log_created_by")
    created_at           = models.DateTimeField(auto_now_add=True)
...
class MucoinInviteLog(models.Model):
    ...
    created_by           = models.ForeignKey(User, on_delete=models.CASCADE, db_column="created_by", related_name="mucoin_invite_log_created_by")
    created_at           = models.DateTimeField(auto_now_add=True)
...
class UserIgLink(models.Model):
    ...
    created_by           = models.ForeignKey(User, on_delete=models.CASCADE, db_column="created_by", related_name="user_ig_link_created_by")
    created_at           = models.DateTimeField(auto_now_add=True)
