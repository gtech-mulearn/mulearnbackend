...
class Channel(models.Model):
    ...
    updated_by = models.ForeignKey(
        User,
        on_delete=models.SET(get_system_admin_id),
...
class KarmaActivityLog(models.Model):
    ...
    peer_approved_by = models.ForeignKey(User, on_delete=models.SET(get_system_admin_id), db_column="peer_approved_by", blank=True,
                                         null=True, related_name="karma_activity_log_peer_approved_by")
    appraiser_approved = models.BooleanField(blank=True, null=True)
    appraiser_approved_by = models.ForeignKey(User, on_delete=models.SET(get_system_admin_id), db_column="appraiser_approved_by",
