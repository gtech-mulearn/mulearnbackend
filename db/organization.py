...
class CampusExecom(models.Model):
    id = models.CharField(primary_key=True, max_length=36, default=uuid.uuid4)
    execom_role = models.ForeignKey(Role, on_delete=models.CASCADE, related_name='campus_execom_role')
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='campus_execom_user')
    campus = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='campus_execom_campus')
