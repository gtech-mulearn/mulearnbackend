...
class User(models.Model):
    ...
    suspended_by   = models.ForeignKey("self", on_delete=models.SET(decouple_config("SYSTEM_ADMIN_ID")), blank=True, null=True, related_name="user_suspended_by_user", db_column="suspended_by")
...
class UserReferralLink(models.Model):
    ...
    updated_by     = models.ForeignKey(User, on_delete=models.SET(decouple_config("SYSTEM_ADMIN_ID")), related_name='user_referral_link_updated_by', db_column='updated_by')
    updated_at     = models.DateTimeField(auto_now=True)
    created_by     = models.ForeignKey(User, on_delete=models.SET(decouple_config("SYSTEM_ADMIN_ID")), related_name='user_referral_link_created_by', db_column='created_by')
    created_at     = models.DateTimeField(auto_now_add=True)
...
class Role(models.Model):
    ...
    updated_by     = models.ForeignKey(User, on_delete=models.SET(decouple_config("SYSTEM_ADMIN_ID")), db_column='updated_by', related_name='role_updated_by')
    updated_at     = models.DateTimeField(auto_now=True)
    created_by     = models.ForeignKey(User, on_delete=models.SET(decouple_config("SYSTEM_ADMIN_ID")), db_column='created_by', related_name='role_created_by')
    created_at     = models.DateTimeField(auto_now_add=True)
...
class Socials(models.Model):
    ...
    created_by     = models.ForeignKey(User, on_delete=models.SET(models.SET(decouple_config("SYSTEM_ADMIN_ID"))), db_column='created_by', related_name='socials_created_by')
    updated_by     = models.ForeignKey(User, on_delete=models.SET(models.SET(decouple_config("SYSTEM_ADMIN_ID"))), db_column='updated_by', related_name='socials_updated_by')
    created_at     = models.DateTimeField(auto_now_add=True)
...
class ForgotPassword(models.Model):
    id             = models.CharField(primary_key=True, max_length=36)
    user           = models.ForeignKey(User, on_delete=models.SET(models.SET(decouple_config("SYSTEM_ADMIN_ID"))))
...
class UserSettings(models.Model):
    id             = models.CharField(primary_key=True, max_length=36, default=uuid.uuid4)
    user           = models.OneToOneField(User, on_delete=models.SET(models.SET(decouple_config("SYSTEM_ADMIN_ID"))), related_name="user_settings_user")
    ...
    updated_at     = models.DateTimeField(auto_now=True)
    created_by     = models.ForeignKey(User, on_delete=models.SET(models.SET(decouple_config("SYSTEM_ADMIN_ID"))), db_column='created_by', related_name='user_settings_created_by')
    created_at     = models.DateTimeField(auto_now_add=True)
...
class DynamicRole(models.Model):
    ...
    updated_by     = models.ForeignKey(User, on_delete=models.SET(models.SET(decouple_config("SYSTEM_ADMIN_ID"))), db_column='updated_by', related_name='dynamic_role_updated_by')
    updated_at     = models.DateTimeField(auto_now=True)
    created_by     = models.ForeignKey(User, on_delete=models.SET(models.SET(decouple_config("SYSTEM_ADMIN_ID"))), db_column='created_by', related_name='dynamic_role_created_by')
    created_at     = models.DateTimeField(auto_now_add=True)
...
class DynamicUser(models.Model):
    ...
    updated_by     = models.ForeignKey('User', on_delete=models.SET(models.SET(decouple_config("SYSTEM_ADMIN_ID"))), db_column='updated_by', related_name='dynamic_user_updated_by')
    updated_at     = models.DateTimeField(auto_now=True)
    created_by     = models.ForeignKey('User', on_delete=models.SET(models.SET(decouple_config("SYSTEM_ADMIN_ID"))), db_column='created_by', related_name='dynamic_user_created_by')
    created_at     = models.DateTimeField(auto_now_add=True)
